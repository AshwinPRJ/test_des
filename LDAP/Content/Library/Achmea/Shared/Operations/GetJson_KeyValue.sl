########################################################################################################################
#!!
#! @description: This operation will retrieve the value of a given key name in a given JSON as a string. If the key name is not unique (in case of a list object containing more than one key with the same name) only the value of the first instance of the key will be retrieved.
#!!#
########################################################################################################################
namespace: Achmea.Shared.Operations
operation:
  name: GetJson_KeyValue
  inputs:
    - dataJson
    - keyName
  python_action:
